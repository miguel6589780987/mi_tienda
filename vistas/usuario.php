...
<b><H1><p class="login-box-msg" > Control de Usuarios </H1></b></p>
  <h1 class="box-title"><button class="btn btn-success" onclick="mostrarform(true)" id="btnagregar"><i class="fa fa-plus-circle"></i>Agregar Usuario</button></h1>
...
<div class="panel-body" id="formularioregistros">
  <form action="" name="formulario" id="formulario" method="POST">
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input type="text" class="form-control" name="num_documento" id="num_documento" placeholder="Número de Identificación " maxlength="20">
    </div>
       <div class="form-group col-lg-6 col-md-6 col-xs-12">
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <img src="" alt="" width="350px" height="260" id="imagenmuestra">
    </div>
