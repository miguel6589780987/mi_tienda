...
$aplicacion=isset($_POST["aplicacion"])? limpiarCadena($_POST["aplicacion"]):"";
...
switch ($_GET["op"]) {
	...
	if (empty($idarticulo)) {
		$rspta=$articulo->insertar($idcategoria,$codigo,$nombre,$stock,$descripcion,$imagen,$aplicacion,$marca);
		echo $rspta ? "Datos registrados correctamente" : "No se pudo registrar los datos";
	}else{
         $rspta=$articulo->editar($idarticulo,$idcategoria,$codigo,$nombre,$stock,$descripcion,$imagen,$aplicacion,$marca);
